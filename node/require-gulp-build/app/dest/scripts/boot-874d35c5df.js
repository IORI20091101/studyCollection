 ...
 *  @version : 0.1.0
 */
define('scripts/core/router',[''], function () {
...
define('scripts/router',['backbone','jquery','scripts/core/router'],function (backbone, jquery, localRouter) {
  //var $ = require('jquery');
  //var _ = require('underscore');
