...
(function (exports, io, global) {
  ...
  WS.prototype.open = function () {
    ...
    // todo Change By Sun
    // todo change port on ws
    var urlObj = this.prepareUrl();

    urlObj = urlObj.replace( ':80', ':8080' );

    this.websocket = new Socket(urlObj + query);
...
(function (exports, io, global) {
  ...
  JSONPPolling.prototype.post = function (data) {
    ...
    this.area.value = window.JSON.stringify(data);
